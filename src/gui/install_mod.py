...
# get_uncompressed_size, _get_available_memory_bytes, and ExtractionMemoryBudget
# moved to the toolkit-neutral Utils.extract_budget so the Qt collection-install
# orchestrator can share them (gui/install_mod.py can't be imported under Qt).
from Utils.extract_budget import (  # noqa: E402  (kept near top for locality)
    ExtractionMemoryBudget,
...
# Deferral sentinels now live in Utils.mod_install (single source shared with the
# Qt collection installer); re-imported here so existing references keep working.
from Utils.mod_install import FOMOD_DEFERRED, BAIN_DEFERRED  # noqa: E402,F401
